...
MIDDLEWARE = [
    ...
    'apps.empresas.middleware.EmpresaMiddleware',  # ✅ Habilitado en Etapa 2 MVP
]
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'ziva_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'ziva_password'),
